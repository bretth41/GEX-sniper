...
// ── NEW v2 SIGNAL STATE (DTE weighting + hysteresis fixes) ────────

// F1
export let f1ScoreEma     = 0;     // 3-bar EMA of raw F1 score
export let f1AvgDte       = 0;     // weighted average DTE of active sweeps

// G1
export let g1ScoreHist    = [];    // rolling 60-min score history for normalization

// WX
export let wxNeutralBarCount = 0;  // bars in neutral zone (for direction lock)
export let wxLockedDir    = 0;     // current locked direction
export let wxScoreHist    = [];    // last 3 raw scores (for GO! gate)
export let wxCompScoreEma = 0;     // 3-bar EMA of wxCompScore

// COSMIC
export let cosmicG1ScoreHist  = []; // rolling G1 history for peg detection
export let cosmicConfirmCount = 0;  // bars of consecutive threshold satisfaction
export let cosmicConfirmDir   = ''; // direction being confirmed

// HEC
export let hecWeakConfirm     = 0;  // consecutive bars at WEAK threshold
export let hecCollapseConfirm = 0;  // consecutive bars at COLLAPSE threshold
